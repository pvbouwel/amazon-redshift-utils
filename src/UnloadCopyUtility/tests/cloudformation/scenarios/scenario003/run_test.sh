...
cd ${HOME}/amazon-redshift-utils/src/UnloadCopyUtility && python2 redshift_unload_copy.py --log-level debug ${HOME}/scenario003.json eu-west-1 >>${STDOUTPUT} 2>>${STDERROR}
