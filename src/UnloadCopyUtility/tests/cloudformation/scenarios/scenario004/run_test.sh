...
cd ${HOME}/amazon-redshift-utils/src/UnloadCopyUtility && python3 redshift_unload_copy.py --log-level debug ${HOME}/scenario004.json eu-west-1 >>${STDOUTPUT} 2>>${STDERROR}
