...
class StackParametersBuilderUnittests(TestCase):
    ...
    def test_is_password_parameter_present(self):
        ...
        parameter_value = 'AQICAHg+xk08AT09LQPwWlubuZPK9qWqnleTQogT9t6BqUCoDQH8RE0SPOUPtzkccSRfqMQiAAAAcjBwBgkqhkiG9w0BBwagYzBhAgEAMFwGCSqGSIb3DQEHATAeBglghkgBZQMEAS4wEQQMizQ+49C8jMM5hs4pAgEQgC/OtruhpIgbPfDn3i3CuMT/f/spg0oVZhFiCZhDphCFOWAsEplz8btht8Datvalng=='
        self.assertParameterSetWithValue(parameter_key, parameter_value)
    ...
    def test_is_copy_role_arn_present(self):
        ...
        parameter_value = 'arn:aws:iam::708106507592:role/rscopyunloadtest3-S3Role-WH7U48ALN2A3'
        self.assertParameterSetWithValue(parameter_key, parameter_value)
